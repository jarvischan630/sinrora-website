...
const products = [
  ...
  { name: "Home Fragrance Line", desc: "Room sprays, diffusers & scented candles. Complete lifestyle fragrance solutions.", emoji: "🏠" },
  { name: "Custom Private Label", desc: "Fully bespoke from bottle to scent to packaging. Your brand, your vision.", emoji: "🏷️" },
];

const categories = [
  { title: "Perfume OEM", btn: "GET INSPIRED", emoji: "🧴" },
  { title: "Essential Oils", btn: "EXPLORE MORE", emoji: "🌿" },
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="fixed right-6 bottom-28 z-50 flex flex-col gap-3">
        <a href="https://wa.me/8613800138000" target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full bg-[#25D366] text-white flex items-center justify-center text-xl shadow-[0_8px_30px_rgba(254,182,193,0.2)] hover:scale-110 transition-transform" title="WhatsApp">
        ...
        <a href="mailto:info@sinrora.com" className="w-14 h-14 rounded-full bg-gradient-to-r from-primary to-primary-dark text-white flex items-center justify-center text-xl shadow-[0_8px_30px_rgba(254,182,193,0.2)] hover:scale-110 transition-transform" title="Email Us">
          ✉
        </a>
      </div>
    </main>
